...
export function TemplatesPage() {
  ...
  const handleCreateTemplate = async (data) => {
    try {
      ...
      addToast({ title: 'Template Saved', message: `Created "${data.title}".`, type: 'success' });
    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description={search ? `No templates match "${search}".` : 'Create your first template.'}
      ...
      <Modal
        ...
        maxWidth="max-w-xl"
      >
        <div className="p-5 bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-200 dark:border-slate-800">
          ...
          <div className="text-xs text-slate-700 dark:text-slate-300 whitespace-pre-wrap font-mono leading-relaxed">
